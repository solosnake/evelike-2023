...
namespace solosnake
{
    ...
    public:
        ...
        void load_suntype_file( const std::string& );
        ...
        solosnake::sunhandle_t get_sun_type( const std::string& );

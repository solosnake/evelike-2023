#ifndef solosnake_textbutton_widgetfactory_hpp
#define solosnake_textbutton_widgetfactory_hpp
...
namespace solosnake
{
    ...
    //! Factory class for creating (Lua) text picturebutton widget types from XML.
    //! A text button displays a centred piece of text, using a font and optional
    //! text scaling.
    class textbutton_widgetfactory : public ilua_widgetfactory
    {
    public:

        textbutton_widgetfactory(

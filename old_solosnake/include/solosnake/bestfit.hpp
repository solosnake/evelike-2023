#ifndef solosnake_bestfit_hpp
#define solosnake_bestfit_hpp
...
namespace solosnake
{
    namespace bestfit
    {
        ...
        //! of the collection.
        std::vector<placedrect> best_fit_rectangle_containing(
            const std::vector<rectangle>& );

        //! Intended for testing, saves the array as a bitmap, empty areas are
        // black.
        void save_bestfit_as_bitmap(
            const char*,
            const std::vector<solosnake::bestfit::placedrect>& );
    }
}

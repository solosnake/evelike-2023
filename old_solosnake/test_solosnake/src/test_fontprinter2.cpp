...
namespace
{
    ...
    void displayFn()
    {
        ...
        g_printer->print_text( utf8text(
                               ...
                               VerticalAlignTop,
                               0.5f + range_to_0_1( varier ) );

        // Long text, unbroken
        g_printer->print_text( utf8text( "long_unbroken_text_123456789ABCDEFGHIJKLMNOPQSTUVWXYZ" ),
                               position2df( 0.5f, 0.5f ),
                               dimension2df(),
                               HorizontalAlignCentre,
                               VerticalAlignTop );

        // Short words, broken
        g_printer->print_text( utf8text( "lots of short words making up this piece of text." ),
                               position2df( 0.5f, 0.6f ),
                               dimension2df(),
                               HorizontalAlignCentre,
                               VerticalAlignTop );

        // Long words, broken
        g_printer->print_text( utf8text( "multiple exaggerated sentences containing looooooooong words." ),
                               position2df( 0.5f, 0.7f ),
                               dimension2df(),
                               HorizontalAlignCentre,
                               VerticalAlignTop );

        // Extender letters
        g_printer->print_text( utf8text( "Yy Pp Qq Ll Ii Jj Kk Dd Gg." ),
                               position2df( 0.5f, 0.8f ),
                               dimension2df(),
                               HorizontalAlignCentre,
                               VerticalAlignTop );

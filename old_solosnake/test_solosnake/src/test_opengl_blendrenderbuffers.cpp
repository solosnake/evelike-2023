...
namespace
{
    ...
    {
        //! 6 faces, 2 triangles each face, 3 vertex per triangle.
        static const unsigned int vertex_count_ = 6 * 2 * 3; 
...
TEST( opengl, blendrenderbuufers )
{
    {
        ...
        EXPECT_EQ( OpenGLVersion[0], 3 );
        EXPECT_EQ( OpenGLVersion[1], 3 );

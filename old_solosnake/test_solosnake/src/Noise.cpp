//
// THIS FILE IS FROM 3D Labs SOURCE CODE ORIGINALLY FOUND AT http://mew.cx/glsl/
// A COPY OF THIS AND MORE IS IN solosnake/external/glsldemo-src-3.8
// D. Stockdale 01 March 2014
//
...
unsigned char* make3DNoiseTexture();

int Noise3DTexSize = 128;
unsigned char* Noise3DTexPtr;
...
unsigned char* make3DNoiseTexture()
{
    ...
    Noise3DTexPtr = (unsigned char*)malloc(Noise3DTexSize * Noise3DTexSize * Noise3DTexSize * 4);

...
#define FONTLETTERS_NAME "TestFSEX300"
#define FONTSIZE (36)
...
namespace
{
    ...
    void displayFn()
    {
        ...
        g_printer->print_text( utf8text( "ABCDEFG AAA BBB CCC XXX DDD EEE FFF GGG" ),
                               position2df( 0.5f, 0.0f ),
                               dimension2df( 0.25f, 0.0 ),
...
TEST( fontprinter, customfont_text )
{
    try
    {

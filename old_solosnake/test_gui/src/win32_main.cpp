...
#include "solosnake/win32/microsoftwindows.hpp"
...
{
    solosnake::microsoftwindows_ptr msw(new solosnake::microsoftwindows(
        hInstance, hPrevInstance, lpCmdLine, nCmdShow, L"test_solosnake"));
    solosnake::singleton<solosnake::microsoftwindows>::instance(msw);
    ...
    solosnake::singleton<solosnake::microsoftwindows>::instance(solosnake::microsoftwindows_ptr());

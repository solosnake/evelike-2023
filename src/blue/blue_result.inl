...
namespace blue
{
    ...
    inline constexpr Result::Result(bool result) noexcept
    ...
    inline constexpr Result failed( const std::string_view& text ) noexcept
    {
        return Result(text);
    }

    inline constexpr Result succeeded() noexcept
    {
        return Result();
    }
}
